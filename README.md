...
The Sketch file in this repository contains reusable UI components that leverage the latest Sketch technology, including "Overrides". Through Sketch Overrides it becomes possible to generate only one component per visual state this component can display on the screen. Using Overrides you can simply override each component property, including graphics, without modifying the design or if you have designers in house they will certainly appreciate the time it will save them by leveraging overrides.
...
To learn more about the file structure and what file you have to modify so you can make your own Live Stream Event Chat App with your own design please read the Customization section included here.
